...
from media_pipe_ros1_msg.msg import  MediaPipeHumanFaceMeshList                            
...
class FaceMeshPublisher():
    ...
    def __init__(self):
        rospy.init_node('mediapipe_face_mesh_publisher')
        self.publisher_ = rospy.Publisher('/mediapipe/human_face_mesh_list', MediaPipeHumanFaceMeshList, queue_size=10)
